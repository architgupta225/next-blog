        ...
        <div className='mb-12 flex items-center gap-12'>
            ...
            <div className='flex-1 flex flex-col gap-5'>
                ...
                <p className='text-[18px] font-light text-softTextColor'>
                    ...
                    Sunt aliquid sed iusto sint beatae accusantium praesentium odio,
                    optio consequatur deleniti quia, dolorem laborum dolores dolor id?
                    Explicabo officia vel molestiae.
                </p>
                <Link href='/' className='border-b border-[crimson] w-max px-0.5'>Read More</Link>
            </div>
        </div>
    )
}
